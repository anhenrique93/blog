<template>
  <div class="bg-primary_dark">
    ...
    >
      ...
      <!-- CONTENT 24 -->
      <div
        class="col-span-5 row-span-5 p-x-3 flex flex-col items-center pt-0 sm:col-span-5 sm:pt-0 md:col-span-5 md:pt-0 lg:col-span-3 lg:pt-24 xl:col-span-3 xl:pt-24 2xl:col-span-3 2xl:pt-24"
      >
        <RouterView class="flex flex-col items-center space-y-12 overflow-y-auto" />
      </div>
      <!-- HEADER RIGHT-SIDE -->
      <div class="col-start-5 row-span-5 flex-col pt-24 hidden ml-40 lg:block">
        <HeaderRight />
      </div>
    </div>
  </div>
